...
[`gcloud storage`](https://cloud.google.com/storage/docs/gsutil_install) command:
~~~
    $ gcloud storage objects add-iam-policy-binding gs://aom-test-data/test-data-file-name --member="allUsers" --role="roles/storage.objectViewer"
~~~
