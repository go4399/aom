...
TEST_P(ResizeCrashTest, DISABLED_TestRestorationFilterCrash) {
  ::libaom_test::Y4mVideoSource video("usnavy_444.y4m", 0, 2);
  cfg_.g_lag_in_frames = 0;
  cfg_.g_profile = 1;
...
AV1_INSTANTIATE_TEST_SUITE(ResizeCrashTest, ::testing::Values(1, 3));
