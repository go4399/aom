...
class AV2EncoderParmsGetToDecoder
    : public ::libaom_test::EncoderTest,
      public ::libaom_test::CodecTestWithParam<EncodeParameters> {
 protected:
  AV2EncoderParmsGetToDecoder()
      : EncoderTest(GET_PARAM(0)), encode_parms(GET_PARAM(1)) {}

  virtual ~AV2EncoderParmsGetToDecoder() {}
...
TEST_P(AV2EncoderParmsGetToDecoder, BitstreamParms) {
...
AV2_INSTANTIATE_TEST_SUITE(AV2EncoderParmsGetToDecoder,
