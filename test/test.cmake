...
if(ENABLE_TESTS)
  ...
  add_library(aom_benchmark ${BENCHMARK_SOURCES})
  target_compile_options(aom_benchmark PRIVATE -std=c++17)
  target_compile_options(aom_benchmark PUBLIC -Wno-undef)
  target_compile_options(aom_benchmark PUBLIC -Wno-missing-declarations)
  target_compile_options(aom_benchmark PUBLIC $<$<COMPILE_LANGUAGE:C>:-Wno-missing-prototypes>)
endif()
  ...
  if(CONFIG_AV1_ENCODER)
    ...
    if(NOT BUILD_SHARED_LIBS)
      ...
      target_link_libraries(test_intra_pred_speed ${AOM_LIB_LINK_TYPE} aom
                            aom_gtest aom_benchmark)
      list(APPEND AOM_APP_TARGETS test_intra_pred_speed)
    endif()
  endif()

  target_compile_options(test_libaom PUBLIC -std=c++17)
  target_include_directories(test_libaom PUBLIC ${AOM_ROOT}/third_party/benchmark/include/benchmark)
  target_link_libraries(test_libaom ${AOM_LIB_LINK_TYPE} aom aom_gtest aom_benchmark)
