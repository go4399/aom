...
if(ENABLE_TESTS)
  ...
  if(NOT (MSVC OR WIN32))
    ...
    target_compile_options(aom_benchmark
                           PUBLIC -Wno-undef -Wno-format-nonliteral
                                  -Wno-missing-declarations -Wno-extra-semi-stmt)
  ...
  if(CONFIG_AV1_ENCODER)
    ...
    if(NOT BUILD_SHARED_LIBS)
      ...
      target_link_libraries(test_intra_pred_speed ${AOM_LIB_LINK_TYPE} aom
                            aom_gtest)
      if(NOT (MSVC OR WIN32))
        target_link_libraries(test_intra_pred_speed ${AOM_LIB_LINK_TYPE} aom_benchmark)
      endif()
