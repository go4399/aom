...
TEST_P(AV2HighBDConvolveScaleTest, Check) { Run(); }
TEST_P(AV2HighBDConvolveScaleTest, DISABLED_Speed) { SpeedTest(); }

#if HAVE_SSE4_1
INSTANTIATE_TEST_SUITE_P(
    SSE4_1, AV2HighBDConvolveScaleTest,
