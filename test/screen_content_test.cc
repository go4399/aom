...
class ScreenContentToolsTestLarge
 ...
 protected:
  ScreenContentToolsTestLarge()
    ...
    screen_content_tools_detection_mode_ = SCT_DETECTION_STANDARD;
  }
  ...
  void PreEncodeFrameHook(::libaom_test::VideoSource *video,
    ...
    if (video->frame() == 0) {
      ...
      encoder->Control(AV1E_SET_SCREEN_CONTENT_TOOLS_DETECTION_MODE,
  ...
  SCT_DETECTION_MODE screen_content_tools_detection_mode_;
};
...
TEST_P(ScreenContentToolsTestLarge, ScreenContentToolsMode2Test) {
  ...
  screen_content_tools_detection_mode_ = SCT_DETECTION_ANTIALIAS_AWARE;
