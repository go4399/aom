...
TEST_P(ScreenContentToolsTestLarge, ScreenContentToolsTest) {
  ...
  // TODO(anyone): Enable below test for mode 1 once low resolution screen
  // content detection issues are fixed. mode 2 allows correct screen content
  // determination of this clip
