...
class DatarateTestSVC
 ...
 protected:
  ...
  virtual void BasicRateTargetingSVC2TL1SLScreenDropFrame1920x10804ThrTest() {
    cfg_.rc_buf_initial_sz = 50;
    cfg_.rc_buf_optimal_sz = 50;
    cfg_.rc_buf_sz = 100;
    cfg_.rc_dropframe_thresh = 30;
...
TEST_P(DatarateTestSVC, BasicRateTargetingSVC2TL1SLScreenDropFrame1920x10804Thr) {
  BasicRateTargetingSVC2TL1SLScreenDropFrame1920x10804ThrTest();
}
