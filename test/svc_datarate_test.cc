      ...
      if (layer_id_.spatial_layer_id == 0 &&
        ...
        if (external_resize_pattern_ == 1) {
          ...
          cfg_.rc_target_bitrate -=
              svc_params_.layer_target_bitrate[5] + svc_params_.layer_target_bitrate[8];
          for (int i = 3; i < 9; ++i) {
        ...
        encoder->Config(&cfg_);
        encoder->Control(AV1E_SET_SVC_PARAMS, &svc_params_);
      } else if (layer_id_.spatial_layer_id == 0 && (video->frame() == 50 || video->frame() == 200)) {
        top_sl_width_ = video->img()->d_w;
        top_sl_height_ = video->img()->d_h;
        if (external_resize_pattern_ == 1) {
        ...
        encoder->Config(&cfg_);
        encoder->Control(AV1E_SET_SVC_PARAMS, &svc_params_);
      } else if (layer_id_.spatial_layer_id == 0 && (video->frame() == 100 || video->frame() == 250)) {
        top_sl_width_ = video->img()->d_w;
        top_sl_height_ = video->img()->d_h;
