...
class DatarateTestSVC
 ...
 protected:
  ...
  virtual void BasicRateTargetingSVC3TL1SLRandomInputTest() {
    ...
    cfg_.rc_target_bitrate = bitrate_array[GET_PARAM(4)];
    ResizingVideoSource video(0, 1280, 720);
    ResetModel();
    SetTargetBitratesFor1SL3TL();
    ASSERT_NO_FATAL_FAILURE(RunLoop(&video));
  }

  virtual void BasicRateTargetingSVC3TL1SLRandomInput2Test() {
    SetUpCbr();
    cfg_.g_error_resilient = 1;
    cfg_.g_w = 1280;
    cfg_.g_h = 720;
  ...
  virtual void BasicRateTargetingSVC3TL1SLRandomInput3Test() {
    SetUpCbr();
    cfg_.g_error_resilient = 1;
    cfg_.g_w = 1280;
    cfg_.g_h = 720;
...
TEST_P(DatarateTestSVC, BasicRateTargetingSVC3TL1SLRandomInput2) {
  BasicRateTargetingSVC3TL1SLRandomInput2Test();
}

TEST_P(DatarateTestSVC, BasicRateTargetingSVC3TL1SLRandomInput3) {
  BasicRateTargetingSVC3TL1SLRandomInput3Test();
}
