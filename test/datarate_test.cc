...
class DatarateTestLarge
 ...
 protected:
  ...
  virtual void BasicRateTargeting720pCBRKf() {
    ::libaom_test::I420VideoSource video("niklas_1280_720_30.y4m", 1280, 720,
                                         30, 1, 0, 500);
...
// Check basic rate targeting for 720p CBR with short keyframe spacing.
TEST_P(DatarateTestRealtime, BasicRateTargeting720pCBRKf) {
  BasicRateTargeting720pCBRKf();
}
