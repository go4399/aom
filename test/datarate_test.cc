...
class DatarateTestLarge
 ...
 protected:
  ...
  virtual void BasicRateTargetingVBRLagRealtime() {
    ...
    // The theshold need to be lowered under CONFIG_REALTIME_ONLY due to the
    // commit 2fed9c389d. If we set cfg_.g_lag_in_frames=0, the variation is
    // smaller, and no need to lower the threshold by this much.
