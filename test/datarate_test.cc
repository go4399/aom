...
class DatarateTestLarge
 ...
 protected:
  ...
  virtual void BasicRateTargetingVgaCBRKf() {
    ::libaom_test::Y4mVideoSource video("crowd_run_360p_10_150f.y4m", 0, 300);
...
TEST_P(DatarateTestRealtime, BasicRateTargetingVgaBRKf) {
  BasicRateTargetingVgaCBRKf();
}
