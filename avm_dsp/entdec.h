...
#define od_ec_dec_bits_ avm_od_ec_dec_bits_
#define od_ec_dec_refill avm_od_ec_dec_refill
#define od_ec_dec_normalize avm_od_ec_dec_normalize
#define od_ec_dec_bypass_normalize avm_od_ec_dec_bypass_normalize
...
int avm_od_ec_decode_cdf_q15_c(od_ec_dec *dec, const uint16_t *icdf, int nsyms);
...
#undef od_ec_enc
#undef od_ec_dec
#undef od_ec_dec_bits_
#undef od_ec_dec_refill
#undef od_ec_dec_normalize
#undef od_ec_dec_bypass_normalize
