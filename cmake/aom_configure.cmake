...
if(HAVE_PTHREAD_H)
  ...
  # in 3.30.0), check_symbol_exists() will modify
  # CMAKE_<LANG>_FLAGS{,_<CONFIG>} and then restore the values afterward. This
  # will create a normal variable which will override the cached variable
  # libaom uses in checking for flags. Due to the level of scope involved, it's
  # easier to clear the normal variable rather than try to propagate the value
  # up through the intermediate scopes.
  if(CMAKE_TRY_COMPILE_CONFIGURATION)
    string(TOUPPER "${CMAKE_TRY_COMPILE_CONFIGURATION}" tc_config)
  else()
    set(tc_config "DEBUG")
  endif()
  unset(CMAKE_C_FLAGS_${tc_config})
  unset(tc_config)
