...
static int firstpass_intra_prediction(
  ...
  set_pixels_to_frame_edge(x, cm->width, cm->height, unit_row * unit_scale,
                           mi_size_high[bsize], unit_col * unit_scale,
                           mi_size_wide[bsize], mi_params->mi_rows,
                           mi_params->mi_cols, cpi->do_border_pad);
