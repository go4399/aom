...
// Table that converts 0-81 Q-range values passed in outside to the Qindex
// range used internally. Entries 64-81 are unclamped "virtual" qindex values
...
static const int quantizer_to_qindex[] = {
  ...
  295, 299, 303, 307, 311, 315, 319, 323, 327,
};
...
int av1_qindex_to_quantizer(int qindex) {
  ...
  for (quantizer = 0; quantizer < 82; ++quantizer)
