...
/**
 * \brief Holds scoring information for reference frames used in pruning.
 */
typedef struct RefScoreData {
  int score; /**< Score value used to rank reference frames */
  int index; /**< Reference frame index */
} RefScoreData;
