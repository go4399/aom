...
int av1_optimize_txb(const struct AV1_COMP *cpi, MACROBLOCK *x, int plane,
  ...
  // For the perceptual tune, increase rshift from 2 to 4.
  // This biases trellis quantization towards keeping more coefficients, and
  // together with the perceptual rdmult adjustment in
  ...
  const int rshift = cpi->oxcf.tune_cfg.tuning == AOM_TUNE_PERCEPTUAL ? 4 : 2;
