...
void av1_cdef_search(AV1_COMP *cpi) {
  ...
  // For adaptive CDEF with strength reduction, zero out entries with low
  // strengths (luma and/or chroma). This is done to reduce decode time, as
