...
static void tpl_store_before_propagation(AomTplBlockStats *tpl_block_stats,
  ...
  tpl_block_stats->srcrf_dist = src_stats->srcrf_dist;
  tpl_block_stats->recrf_sse = src_stats->recrf_sse;
  tpl_block_stats->recrf_dist = src_stats->recrf_dist;
  tpl_block_stats->intra_sse = src_stats->intra_sse;
  tpl_block_stats->intra_dist = src_stats->intra_dist;
...
static void free_tpl_gop_stats(AomTplGopStats *tpl_gop_stats) {
...
static void init_tpl_stats_before_propagation(
    ...
    int frame_height) {
  free_tpl_gop_stats(tpl_gop_stats);
  AOM_CHECK_MEM_ERROR(
