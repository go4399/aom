...
/*! \brief Set *num_colors to the number of colors in src.
   ...
   Note: If the function returns true, *num_colors is accurate (and is <=
   num_colors_threshold). If the function returns false, *num_colors may be
   smaller than the actual value (and is > num_colors_threshold).
 */
