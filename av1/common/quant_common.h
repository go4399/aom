...
#define QM_FIRST_VIQO 2
#define QM_LAST_VIQO 10
...
// Luma QM levels tuned for visual image quality optimization (VIQO)
...
// For more information on quantization matrices, please refer to
// https://arxiv.org/pdf/2008.06091, section F.
static inline int aom_get_qmlevel_luma_viqo(int qindex, int first, int last) {
  int qm_level = 0;
...
// Chroma QM levels for 4:4:4 subsampling tuned for visual image quality
// optimization (VIQO)
// This formula was empirically derived by encoding Daala's subset1 validation
// testset for each QP/QM tuple, and building a convex hull that maximizes
// SSIMULACRA 2 scores, and a final subjective visual quality pass as a quick
...
// For more information on quantization matrices, please refer to
// https://arxiv.org/pdf/2008.06091, section F.
static inline int aom_get_qmlevel_444_chroma_viqo(int qindex, int first,
                                                  int last) {
