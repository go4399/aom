...
// table is a workaround until the intrinsic code paths can coalesce to the
// change. The x86 path already has an 8-bit version of the table (see
// av1_filter_8bit in av1/common/x86/warp_plane_sse4.c).
// This enables 8-bit computation instructions and reduces memory bandwidth.
//
...
#endif /* AOM_USE_8BIT_WARPED_FILTER_TABLE */
