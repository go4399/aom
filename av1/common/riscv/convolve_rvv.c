...
static inline vuint8mf2_t convolve4_8_x_rvv(
  ...
  return __riscv_vnclipu_wx_u8mf2(d0, FILTER_BITS - 1, vl);
...
void av1_convolve_x_sr_intrabc_rvv(const uint8_t *src, int src_stride,
  ...
  if (w <= 8) {
    do {
      ...
      // Average the values
#if __riscv_v_intrinsic == 11000
      vuint8mf2_t d0 = __riscv_vaaddu_vv_u8mf2(s0_0, s0_1, vl);
      vuint8mf2_t d1 = __riscv_vaaddu_vv_u8mf2(s1_0, s1_1, vl);
#elif __riscv_v_intrinsic >= 12000
      vuint8mf2_t d0 =
    ...
    do {
      ...
      do {
        ...
        // Average the values
#if __riscv_v_intrinsic == 11000
        vuint8m1_t d0 = __riscv_vaaddu_vv_u8m1(s0, s1, vl);
        vuint8m1_t d1 = __riscv_vaaddu_vv_u8m1(s2, s3, vl);
#elif __riscv_v_intrinsic >= 12000
...
void av1_convolve_y_sr_intrabc_rvv(const uint8_t *src, int src_stride,
  ...
  if (w <= 8) {
    ...
    do {
      ...
      // Average the values
#if __riscv_v_intrinsic == 11000
      vuint8mf2_t d0 = __riscv_vaaddu_vv_u8mf2(s0, s1, vl);
      vuint8mf2_t d1 = __riscv_vaaddu_vv_u8mf2(s1, s2, vl);
#elif __riscv_v_intrinsic >= 12000
...
#if __riscv_v_intrinsic == 11000
        vuint8m1_t d0 = __riscv_vaaddu_vv_u8m1(s0, s1, vl);
        vuint8m1_t d1 = __riscv_vaaddu_vv_u8m1(s1, s2, vl);
#elif __riscv_v_intrinsic >= 12000
        vuint8m1_t d0 = __riscv_vaaddu_vv_u8m1(s0, s1, __RISCV_VXRM_RNU, vl);
  ...
  if (w <= 8) {
    ...
    do {
      ...
      vuint8mf2_t d0 = __riscv_vnclipu_wx_u8mf2(
          __riscv_vadd_vv_u16m1(sum0, sum1, vl), 2, vl);
      vuint8mf2_t d1 = __riscv_vnclipu_wx_u8mf2(
          __riscv_vadd_vv_u16m1(sum1, sum2, vl), 2, vl);
#elif __riscv_v_intrinsic >= 12000
      vuint8mf2_t d0 = __riscv_vnclipu_wx_u8mf2(
