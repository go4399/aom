  ...
  if (w == 4) {
    ...
    for (int i = 0; i < h; ++i) {
      for (int j = 0; j < w; j += vw) {
        ...
        hn::StoreU(hn::DemoteTo(pixel_tag, result), pixel_tag, &dst[j]);
      }
      src += src_stride;
      dst += dst_stride;
    }
  ...
  if (w == 4) {
    ...
    for (int i = 0; i < h; ++i) {
      for (int j = 0; j < w; j += vw) {
        ...
        auto src2 = hn::PromoteTo(mul_tag, hn::LoadU(pixel_tag, &src[j + 2]));
        auto src3 = hn::PromoteTo(mul_tag, hn::LoadU(pixel_tag, &src[j + 3]));
        auto src4 = hn::PromoteTo(mul_tag, hn::LoadU(pixel_tag, &src[j + 4]));
        auto src5 = hn::PromoteTo(mul_tag, hn::LoadU(pixel_tag, &src[j + 5]));
        auto src6 = hn::PromoteTo(mul_tag, hn::LoadU(pixel_tag, &src[j + 6]));
        auto src7 = hn::PromoteTo(mul_tag, hn::LoadU(pixel_tag, &src[j + 7]));
