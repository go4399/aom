    ...
    if (w == 4) {
      ...
      if (h & 1) {
        for (int j = 0; j < 32; j += 8) {
          auto r0_d0 = hn::LoadU(tag8_16, src + j + 0);
          auto r0_sum = hn::SatWidenMulPairwiseAdd(
              tag16_8, hn::TableLookupBytes(r0_d0, shuffle_mask), coeff34);
          hn::StoreU(hn::DemoteTo(tag8_8, hn::ShiftRight<FILTER_BITS - 1>(
                                              hn::Add(r0_sum, bias_val))),
  ...
  if (can_use_optimized_path) {
    ...
    if (w == 4) {
      while (h >= 2) {
        ...
        auto r0_sum = ComputeHoriz4TapSum(tag16_8, tag8_16, r0_d0, r0_d2,
                                          shuffle_mask, coeff23, coeff45);

        auto r1_sum = ComputeHoriz4TapSum(tag16_8, tag8_16, r1_d0, r1_d2,
                                          shuffle_mask, coeff23, coeff45);
      ...
      while (h >= 2) {
        ...
        auto r0_j0_sum =
            ComputeHoriz4TapSum(tag16_8, tag8_16, r0_j0_d0, r0_j0_d2,
                                shuffle_mask, coeff23, coeff45);

        auto r0_j8_sum =
            ComputeHoriz4TapSum(tag16_8, tag8_16, r0_j8_d0, r0_j8_d2,
                                shuffle_mask, coeff23, coeff45);

        auto r1_j0_sum =
            ComputeHoriz4TapSum(tag16_8, tag8_16, r1_j0_d0, r1_j0_d2,
                                shuffle_mask, coeff23, coeff45);

        auto r1_j8_sum =
            ComputeHoriz4TapSum(tag16_8, tag8_16, r1_j8_d0, r1_j8_d2,
                                shuffle_mask, coeff23, coeff45);
      ...
      while (h >= 2) {
        ...
        }
        {
          ...
          auto r0_j16_sum =
              ComputeHoriz4TapSum(tag16_8, tag8_16, r0_j16_d0, r0_j16_d2,
                                  shuffle_mask, coeff23, coeff45);

          auto r0_j24_sum =
              ComputeHoriz4TapSum(tag16_8, tag8_16, r0_j24_d0, r0_j24_d2,
                                  shuffle_mask, coeff23, coeff45);

          auto r1_j16_sum =
              ComputeHoriz4TapSum(tag16_8, tag8_16, r1_j16_d0, r1_j16_d2,
                                  shuffle_mask, coeff23, coeff45);

          auto r1_j24_sum =
              ComputeHoriz4TapSum(tag16_8, tag8_16, r1_j24_d0, r1_j24_d2,
                                  shuffle_mask, coeff23, coeff45);
      ...
      if (h & 1) {
        for (int j = 0; j < 32; j += 8) {
          auto r0_d0 = hn::LoadU(tag8_16, src + j + 0);
          auto r0_d2 = hn::LoadU(tag8_16, src + j + 2);
  ...
  if (can_use_optimized_path) {
    ...
    if (w == 4) {
      while (h >= 2) {
        ...
        auto r0_sum = ComputeHoriz8TapSum(tag16_8, tag8_16, r0_d0, r0_d2, r0_d4,
                                          r0_d6, shuffle_mask, coeff01, coeff23,
                                          coeff45, coeff67);

        auto r1_sum = ComputeHoriz8TapSum(tag16_8, tag8_16, r1_d0, r1_d2, r1_d4,
                                          r1_d6, shuffle_mask, coeff01, coeff23,
                                          coeff45, coeff67);
      ...
      while (h >= 2) {
        ...
        auto r0_j0_sum = ComputeHoriz8TapSum(
            tag16_8, tag8_16, r0_j0_d0, r0_j0_d2, r0_j0_d4, r0_j0_d6,
            shuffle_mask, coeff01, coeff23, coeff45, coeff67);

        auto r0_j8_sum = ComputeHoriz8TapSum(
            tag16_8, tag8_16, r0_j8_d0, r0_j8_d2, r0_j8_d4, r0_j8_d6,
            shuffle_mask, coeff01, coeff23, coeff45, coeff67);

        auto r1_j0_sum = ComputeHoriz8TapSum(
            tag16_8, tag8_16, r1_j0_d0, r1_j0_d2, r1_j0_d4, r1_j0_d6,
            shuffle_mask, coeff01, coeff23, coeff45, coeff67);

        auto r1_j8_sum = ComputeHoriz8TapSum(
            tag16_8, tag8_16, r1_j8_d0, r1_j8_d2, r1_j8_d4, r1_j8_d6,
            shuffle_mask, coeff01, coeff23, coeff45, coeff67);
      ...
      while (h >= 2) {
        ...
        }
        {
          ...
          auto r0_j16_sum = ComputeHoriz8TapSum(
              tag16_8, tag8_16, r0_j16_d0, r0_j16_d2, r0_j16_d4, r0_j16_d6,
              shuffle_mask, coeff01, coeff23, coeff45, coeff67);

          auto r0_j24_sum = ComputeHoriz8TapSum(
              tag16_8, tag8_16, r0_j24_d0, r0_j24_d2, r0_j24_d4, r0_j24_d6,
              shuffle_mask, coeff01, coeff23, coeff45, coeff67);

          auto r1_j16_sum = ComputeHoriz8TapSum(
              tag16_8, tag8_16, r1_j16_d0, r1_j16_d2, r1_j16_d4, r1_j16_d6,
              shuffle_mask, coeff01, coeff23, coeff45, coeff67);

          auto r1_j24_sum = ComputeHoriz8TapSum(
              tag16_8, tag8_16, r1_j24_d0, r1_j24_d2, r1_j24_d4, r1_j24_d6,
              shuffle_mask, coeff01, coeff23, coeff45, coeff67);
      ...
      if (h & 1) {
        for (int j = 0; j < 32; j += 8) {
          auto r0_d0 = hn::LoadU(tag8_16, src + j + 0);
          auto r0_d2 = hn::LoadU(tag8_16, src + j + 2);
          auto r0_d4 = hn::LoadU(tag8_16, src + j + 4);
          auto r0_d6 = hn::LoadU(tag8_16, src + j + 6);

          auto r0_sum = ComputeHoriz8TapSum(tag16_8, tag8_16, r0_d0, r0_d2,
                                            r0_d4, r0_d6, shuffle_mask, coeff01,
                                            coeff23, coeff45, coeff67);
