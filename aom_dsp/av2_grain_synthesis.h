 ...
 *
 */
#ifndef AV2_AOM_DSP_GRAIN_SYNTHESIS_H_
#define AV2_AOM_DSP_GRAIN_SYNTHESIS_H_
 ...
 */
int av2_add_film_grain_run(const aom_film_grain_t *grain_params, uint8_t *luma,
 ...
 */
int av2_add_film_grain(const aom_film_grain_t *grain_params,
...
#endif  // AV2_AOM_DSP_GRAIN_SYNTHESIS_H_
