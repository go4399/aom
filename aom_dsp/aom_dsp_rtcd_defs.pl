...
if (aom_config("CONFIG_AV1_ENCODER") eq "yes") {
  ...
  specialize qw/aom_sad128x128    sse2 avx2 neon neon_dotprod/;
  specialize qw/aom_sad128x64     sse2 avx2 neon neon_dotprod/;
  specialize qw/aom_sad64x128     sse2 avx2 neon neon_dotprod/;
  specialize qw/aom_sad64x64      sse2 avx2 neon neon_dotprod/;
  specialize qw/aom_sad64x32      sse2 avx2 neon neon_dotprod/;
  specialize qw/aom_sad32x64      sse2 avx2 neon neon_dotprod/;
  specialize qw/aom_sad32x32      sse2 avx2 neon neon_dotprod/;
  specialize qw/aom_sad32x16      sse2 avx2 neon neon_dotprod/;
  ...
  if (aom_config("AOM_ARCH_X86_64") eq "yes") {
    ...
    specialize qw/aom_sad32x64      avx512/;
    specialize qw/aom_sad32x32      avx512/;
    specialize qw/aom_sad32x16      avx512/;
  }
