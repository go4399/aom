...
#define aom_calc_highbd_psnr_6(a, b, psnr, bd, in_bd, lossless) aom_calc_highbd_psnr(a, b, psnr, bd, in_bd)
#define aom_calc_highbd_psnr_5(a, b, psnr, bd, in_bd) aom_calc_highbd_psnr(a, b, psnr, bd, in_bd)
#define GET_PSNR_MACRO(_1, _2, _3, _4, _5, _6, NAME, ...) NAME
#define aom_calc_highbd_psnr(...) GET_PSNR_MACRO(__VA_ARGS__, aom_calc_highbd_psnr_6, aom_calc_highbd_psnr_5)(__VA_ARGS__)
#endif
#endif
