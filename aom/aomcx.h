...
#define AOM_HAVE_TUNE_SSIMULACRA2 1
  /* Tune that optimizes for maximum SSIMULACRA 2 scores. Shares the rdmult
     code with AOM_TUNE_SSIM.
     Unlike metrics like AOM_TUNE_VMAF or AOM_TUNE_BUTTERAUGLI,
     ...
     purely on hand-crafted heuristics. This means libaom doesn't need to
     take on any additional external dependencies.
     ...
     that been shown to negatively impact subjective quality in human
     evaluations.
     */
