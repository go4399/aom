...
enum aome_enc_control_id {
   ...
   *
   * - AOM_SCREEN_DETECTION_STANDARD = standard (default)
   * - AOM_SCREEN_DETECTION_ANTIALIASING_AWARE = anti-aliased text and graphics
   *   aware
   */
...
typedef enum {
  AOM_SCREEN_DETECTION_STANDARD = 1, /**< Standard */
