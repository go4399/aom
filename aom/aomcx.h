 ...
 *
 * \note
 * AOM_TUNE_VIQO is restricted to all intra mode (AOM_USAGE_ALL_INTRA). Setting
 * the tuning option to AOM_TUNE_VIQO causes the following options to be set
...
/*!\brief Allows detection of the presence of AOM_TUNE_VIQO at compile time. */
#define AOM_HAVE_TUNE_VIQO 1
  /* Visual image quality optimization (VIQO). Increases image quality and
   * consistency, guided by the SSIMULACRA 2 metric and subjective quality
   * checks. Shares the rdmult code with AOM_TUNE_SSIM.
   */
  AOM_TUNE_VIQO = 10,
} aom_tune_metric;
