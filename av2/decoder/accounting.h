 ...
 */
#ifndef AV2_AV2_DECODER_ACCOUNTING_H_
#define AV2_AV2_DECODER_ACCOUNTING_H_
#include <stdlib.h>
#include "aom/aomdx.h"
...
#define AV2_ACCOUNTING_HASH_SIZE (1021)
...
/*The resolution of fractional-precision bit usage measurements, i.e.,
   16 => 1/65536th bits.*/
#define AV2_ACCT_BITRES (16)

#define AV2_ACCOUNTING_MAX_TAGS (4)
...
typedef struct {
  ...
  const char *c_file;
  int c_line;
  const char *tags[AV2_ACCOUNTING_MAX_TAGS];
...
#define ACCT_INFO0() \
  av2_accounting_make_info(__func__, __FILE__, __LINE__, NULL, NULL, NULL, NULL)
#define ACCT_INFO1(tag0) \
  av2_accounting_make_info(__func__, __FILE__, __LINE__, tag0, NULL, NULL, NULL)
#define ACCT_INFO2(tag0, tag1) \
  av2_accounting_make_info(__func__, __FILE__, __LINE__, tag0, tag1, NULL, NULL)
#define ACCT_INFO3(tag0, tag1, tag2) \
  av2_accounting_make_info(__func__, __FILE__, __LINE__, tag0, tag1, tag2, NULL)
#define ACCT_INFO4(tag0, tag1, tag2, tag3) \
  av2_accounting_make_info(__func__, __FILE__, __LINE__, tag0, tag1, tag2, tag3)
...
struct Accounting {
  ...
  int16_t hash_dictionary[AV2_ACCOUNTING_HASH_SIZE];
  AccountingSymbolContext context;
...
#endif  // __cplusplus
#endif  // AV2_AV2_DECODER_ACCOUNTING_H_
