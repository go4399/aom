...
static INLINE void read_ci_color_info(struct ContentInterpretation *ci_params,
  ...
  col_info->color_primaries = (aom_color_primaries_t)color_primaries;
...
uint32_t av2_read_content_interpretation_obu(struct AV2Decoder *pbi,
  ...
  if (ci_temp.ci_color_description_present_flag) {
    ...
    ci_temp.color_info.color_description_idc = AV2_COLOR_DESC_IDC_EXPLICIT;
    ci_temp.color_info.color_primaries = AOM_CICP_CP_UNSPECIFIED;
    ci_temp.color_info.transfer_characteristics = AOM_CICP_TC_UNSPECIFIED;
    ci_temp.color_info.matrix_coefficients = AOM_CICP_MC_UNSPECIFIED;
  ...
  if (ci_temp.ci_chroma_sample_position_present_flag) {
    ...
    ci_temp.ci_chroma_sample_position[0] = AOM_CSP_UNKNOWN;
    ci_temp.ci_chroma_sample_position[1] = AOM_CSP_UNKNOWN;
  }
