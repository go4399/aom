...
#define AVM_CODEC_CX_FRAME_NULL_PKT AOM_CODEC_CX_FRAME_PKT
...
#define aom_codec_control_type_AV2E_SET_USER_DEFINED_QMATRIX avm_user_defined_qm_t *
...
#define aom_codec_control_type_AV2E_SET_CHROMA_SAMPLE_POSITION aom_chroma_sample_position_t
...
#define aom_codec_control_type_AV2E_SET_ENABLE_BUFFER_REFRESH_TEST avm_buffer_refresh_test_t *
...
#define aom_codec_control_type_AV2E_SET_MATRIX_COEFFICIENTS aom_matrix_coefficients_t
...
#define aom_codec_control_type_AV2E_SET_TRANSFER_CHARACTERISTICS aom_transfer_characteristics_t
...
#define avm_active_map_t aom_active_map_t
#define avm_scaling_mode_t aom_scaling_mode_t
...
static aom_codec_err_t validate_config(aom_codec_alg_priv_t *ctx,
  ...
  RANGE_CHECK(cfg, kf_mode, AVM_KF_DISABLED, AOM_KF_AUTO);
...
static aom_codec_err_t set_encoder_config(AV2EncoderConfig *oxcf,
  ...
  oxcf->border_in_pixels =
      resize_cfg->resize_mode ? AOM_BORDER_IN_PIXELS : AVM_ENC_NO_SCALE_BORDER;
  ...
  if (res == AOM_CODEC_OK) {
    ...
    if (img != NULL) {
      ...
      if (!(img->fmt & AOM_IMG_FMT_HIGHBITDEPTH)) {
        hbd_img = avm_img_alloc(NULL, img->fmt | AOM_IMG_FMT_HIGHBITDEPTH,
                                img->d_w, img->d_h, 32);
...
aom_codec_iface_t avm_codec_av2_cx_algo_temp = {
  ...
  },
  {
      ...
      (const void *)encoder_get_global_headers,  // avm_codec_get_global_headers_fn_t
      encoder_get_preview          // avm_codec_get_preview_frame_fn_t
  },
  encoder_set_option  // avm_codec_set_option_fn_t
};

aom_codec_iface_t *avm_codec_av2_cx(void) { return &avm_codec_av2_cx_algo_temp; }
