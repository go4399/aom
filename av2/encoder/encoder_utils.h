...
#ifndef AV2_AV2_ENCODER_ENCODER_UTILS_H_
#define AV2_AV2_ENCODER_ENCODER_UTILS_H_
...
extern const int av2_default_tx_type_probs[FRAME_UPDATE_TYPES][TX_SIZES_ALL_AV2]
                                          [TX_TYPES];
...
static INLINE void suppress_active_map(AV2_COMP *cpi) {
...
#define HIGHBD_BFP(BT, SDF, SDAF, VF, SVF, SVAF, SDX4DF, JSDAF, JSVAF) \
  cpi->fn_ptr[BT].sdf = (aom_sad_fn_t)SDF;                             \
  cpi->fn_ptr[BT].sdaf = (aom_sad_avg_fn_t)SDAF;                       \
  cpi->fn_ptr[BT].vf = (aom_variance_fn_t)VF;                          \
  cpi->fn_ptr[BT].svf = (aom_subpixvariance_fn_t)SVF;                  \
  cpi->fn_ptr[BT].svaf = (aom_subp_avg_variance_fn_t)SVAF;             \
  cpi->fn_ptr[BT].sdx4df = (aom_sad_multi_d_fn_t)SDX4DF;               \
  cpi->fn_ptr[BT].jsdaf = (aom_dist_wtd_sad_avg_fn_t)JSDAF;            \
  cpi->fn_ptr[BT].jsvaf = (aom_dist_wtd_subp_avg_variance_fn_t)JSVAF;

#define HIGHBD_BFP_WRAPPER(WIDTH, HEIGHT, BD)                                \
  HIGHBD_BFP(                                                                \
      BLOCK_##WIDTH##X##HEIGHT, av2_highbd_sad##WIDTH##x##HEIGHT##_bits##BD, \
      av2_highbd_sad##WIDTH##x##HEIGHT##_avg_bits##BD,                       \
      ...
      av2_highbd_sad##WIDTH##x##HEIGHT##x4d_bits##BD,                        \
      av2_highbd_dist_wtd_sad##WIDTH##x##HEIGHT##_avg_bits##BD,              \
...
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad256x256)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad256x256_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad256x256x4d)

MAKE_BFP_SAD_WRAPPER(av2_highbd_sad256x128)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad256x128_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad256x128x4d)

MAKE_BFP_SAD_WRAPPER(av2_highbd_sad128x256)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad128x256_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad128x256x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad128x128)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad128x128_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad128x128x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad128x64)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad128x64_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad128x64x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad64x128)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad64x128_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad64x128x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad32x16)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad32x16_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad32x16x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad16x32)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad16x32_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad16x32x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad64x32)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad64x32_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad64x32x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad32x64)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad32x64_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad32x64x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad32x32)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad32x32_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad32x32x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad64x64)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad64x64_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad64x64x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad16x16)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad16x16_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad16x16x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad16x8)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad16x8_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad16x8x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad8x16)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad8x16_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad8x16x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad8x8)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad8x8_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad8x8x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad8x4)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad8x4_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad8x4x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad4x8)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad4x8_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad4x8x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad4x4)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad4x4_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad4x4x4d)

MAKE_BFP_SAD_WRAPPER(av2_highbd_sad4x16)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad4x16_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad4x16x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad16x4)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad16x4_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad16x4x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad8x32)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad8x32_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad8x32x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad32x8)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad32x8_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad32x8x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad16x64)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad16x64_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad16x64x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad64x16)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad64x16_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad64x16x4d)

MAKE_BFP_SAD_WRAPPER(av2_highbd_sad64x8)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad64x8_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad64x8x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad8x64)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad8x64_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad8x64x4d)

MAKE_BFP_SAD_WRAPPER(av2_highbd_sad64x4)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad64x4_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad64x4x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad4x64)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad4x64_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad4x64x4d)

MAKE_BFP_SAD_WRAPPER(av2_highbd_sad32x4)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad32x4_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad32x4x4d)
MAKE_BFP_SAD_WRAPPER(av2_highbd_sad4x32)
MAKE_BFP_SADAVG_WRAPPER(av2_highbd_sad4x32_avg)
MAKE_BFP_SAD4D_WRAPPER(av2_highbd_sad4x32x4d)

MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad256x256_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad256x128_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad128x256_avg)

MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad128x128_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad128x64_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad64x128_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad32x16_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad16x32_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad64x32_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad32x64_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad32x32_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad64x64_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad16x16_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad16x8_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad8x16_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad8x8_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad8x4_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad4x8_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad4x4_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad4x16_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad16x4_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad8x32_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad32x8_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad16x64_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad64x16_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad8x64_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad64x8_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad4x64_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad64x4_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad4x32_avg)
MAKE_BFP_JSADAVG_WRAPPER(av2_highbd_dist_wtd_sad32x4_avg)

#define HIGHBD_MBFP(BT, MCSDF, MCSVF)                \
  cpi->fn_ptr[BT].msdf = (aom_masked_sad_fn_t)MCSDF; \
  cpi->fn_ptr[BT].msvf = (aom_masked_subpixvariance_fn_t)MCSVF;

#define HIGHBD_MBFP_WRAPPER(WIDTH, HEIGHT, BD)                    \
  HIGHBD_MBFP(BLOCK_##WIDTH##X##HEIGHT,                           \
              av2_highbd_masked_sad##WIDTH##x##HEIGHT##_bits##BD, \
...
// fnname is aom_highbd_masked_sad*, which applies CONVERT_TO_SHORTPTR to its
// pixel pointers. Callers pass real uint16_t* (as uint8_t*) per the AV2 fn_ptr
// convention (matching the variance/msvf wrappers), so tag src/ref/second_pred
// with CONVERT_TO_BYTEPTR here. The mask (m) is a real uint8_t* alpha map.
#define MAKE_MBFP_COMPOUND_SAD_WRAPPER(fnname)                                  \
  static unsigned int fnname##_bits8(                                          \
    ...
    return fnname(CONVERT_TO_BYTEPTR((const uint16_t *)src_ptr), source_stride,\
                  CONVERT_TO_BYTEPTR((const uint16_t *)ref_ptr), ref_stride,   \
                  CONVERT_TO_BYTEPTR((const uint16_t *)second_pred_ptr), m,    \
...
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad256x256)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad256x128)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad128x256)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad128x128)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad128x64)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad64x128)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad64x64)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad64x32)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad32x64)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad32x32)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad32x16)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad16x32)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad16x16)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad16x8)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad8x16)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad8x8)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad8x4)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad4x8)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad4x4)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad4x16)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad16x4)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad8x32)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad32x8)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad16x64)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad64x16)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad8x64)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad64x8)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad4x64)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad64x4)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad4x32)
MAKE_MBFP_COMPOUND_SAD_WRAPPER(av2_highbd_masked_sad32x4)

#define HIGHBD_SDSFP(BT, SDSF, SDSX4DF)      \
  cpi->fn_ptr[BT].sdsf = (aom_sad_fn_t)SDSF; \
  cpi->fn_ptr[BT].sdsx4df = (aom_sad_multi_d_fn_t)SDSX4DF;

#define HIGHBD_SDSFP_WRAPPER(WIDTH, HEIGHT, BD)                   \
  HIGHBD_SDSFP(BLOCK_##WIDTH##X##HEIGHT,                          \
               av2_highbd_sad_skip_##WIDTH##x##HEIGHT##_bits##BD, \
               av2_highbd_sad_skip_##WIDTH##x##HEIGHT##x4d##_bits##BD)
...
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_256x256)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_256x128)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_128x256)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_128x128)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_128x64)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_64x128)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_64x64)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_64x32)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_64x16)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_32x64)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_32x32)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_32x16)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_32x8)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_16x64)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_16x32)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_16x16)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_16x8)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_8x16)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_8x8)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_4x16)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_4x8)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_8x32)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_8x64)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_64x8)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_4x64)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_64x4)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_4x32)
MAKE_SDSF_SKIP_SAD_WRAPPER(av2_highbd_sad_skip_32x4)

MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_256x256x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_256x128x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_128x256x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_128x128x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_128x64x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_64x128x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_64x64x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_64x32x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_64x16x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_32x64x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_32x32x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_32x16x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_32x8x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_16x64x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_16x32x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_16x16x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_16x8x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_8x16x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_8x8x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_4x16x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_4x8x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_8x32x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_8x64x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_64x8x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_4x64x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_64x4x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_4x32x4d)
MAKE_SDSF_SKIP_SAD_4D_WRAPPER(av2_highbd_sad_skip_32x4x4d)
...
static INLINE void copy_frame_prob_info(AV2_COMP *cpi) {
...
static INLINE void set_size_independent_vars(AV2_COMP *cpi) {
  int i;
  AV2_COMMON *const cm = &cpi->common;
...
static INLINE void release_scaled_references(AV2_COMP *cpi) {
...
static INLINE void refresh_reference_frames(AV2_COMP *cpi) {
  AV2_COMMON *const cm = &cpi->common;
...
static INLINE void update_subgop_stats(
...
static INLINE void update_subgop_ref_stats(SubGOPStatsEnc *const subgop_stats,
                                           unsigned int enable_subgop_stats,
                                           int ref_frame,
                                           int is_valid_ref_frame,
                                           int pyramid_level, int disp_order,
                                           int num_references) {
  if (!enable_subgop_stats) return;
  assert(subgop_stats->stat_count < MAX_SUBGOP_STATS_SIZE);
...
static INLINE void av2_set_seq_tile_info(SequenceHeader *const seq_params,
                                         const AV2EncoderConfig *oxcf) {
...
static INLINE void av2_set_tile_info(AV2_COMMON *const cm,
...
#endif  // AV2_AV2_ENCODER_ENCODER_UTILS_H_
