...
static INLINE void model_rd_from_sse(const AV2_COMP *const cpi,
                                     const MACROBLOCK *const x,
                                     BLOCK_SIZE plane_bsize, int plane,
                                     int64_t sse, int num_samples, int *rate,
                                     int64_t *dist) {
...
static INLINE void model_rd_with_curvfit(const AV2_COMP *const cpi,
                                         const MACROBLOCK *const x,
                                         BLOCK_SIZE plane_bsize, int plane,
...
static INLINE void model_rd_for_sb(const AV2_COMP *const cpi, BLOCK_SIZE bsize,
