...
#ifndef AV2_AV2_ENCODER_RATECTRL_H_
#define AV2_AV2_ENCODER_RATECTRL_H_
...
#define MAX_GF_INTERVAL_AV2 16
#define MAX_GF_LENGTH_LAP_AV2 MAX_GF_INTERVAL_AV2
...
double av2_convert_qindex_to_q(int qindex, aom_bit_depth_t bit_depth);
...
int av2_find_qindex(double desired_q, aom_bit_depth_t bit_depth,
...
#endif  // AV2_AV2_ENCODER_RATECTRL_H_
