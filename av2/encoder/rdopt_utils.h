...
#ifndef AV2_AV2_ENCODER_RDOPT_UTILS_H_
#define AV2_AV2_ENCODER_RDOPT_UTILS_H_
...
static INLINE void get_txb_dimensions(const MACROBLOCKD *xd, int plane,
                                      ...
                                      int txb_height, int *width, int *height,
...
static INLINE int get_visible_dimensions(const MACROBLOCKD *xd, int plane,
                                         int blk_col, int blk_row, int cols,
                                         int rows, int frame_width,
                                         int frame_height, int *visible_cols,
                                         int *visible_rows) {
  const struct macroblockd_plane *const pd = &xd->plane[plane];
...
#endif  // AV2_AV2_ENCODER_RDOPT_UTILS_H_
