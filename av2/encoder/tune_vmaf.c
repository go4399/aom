...
static void motion_search(AV2_COMP *cpi, const YV12_BUFFER_CONFIG *src,
  ...
  const int step_param =
      av2_init_search_range(AOMMAX(src->y_crop_width, src->y_crop_height),
...
static INLINE void unsharp(const AV2_COMP *const cpi,
...
static INLINE double cal_approx_vmaf(const AV2_COMP *const cpi,
...
static INLINE void get_neighbor_frames(const AV2_COMP *const cpi,
