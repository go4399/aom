...
static INLINE void av2_ml_part_split_features_square(AV2_COMP *const cpi,
...
static INLINE void av2_ml_part_split_features_none(AV2_COMP *const cpi,
                                                   MACROBLOCK *x, int mi_row,
...
static INLINE void av2_ml_part_split_features(AV2_COMP *const cpi,
                                              MACROBLOCK *x, int mi_row,
                                              int mi_col, BLOCK_SIZE bsize,
                                              float *out_features) {
  MACROBLOCKD *xd = &x->e_mbd;
