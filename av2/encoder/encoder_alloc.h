...
static INLINE void alloc_compressor_data(AV2_COMP *cpi) {
...
static INLINE void realloc_segmentation_maps(AV2_COMP *cpi) {
...
static INLINE void dealloc_compressor_data(AV2_COMP *cpi) {
  AV2_COMMON *const cm = &cpi->common;
  TokenInfo *token_info = &cpi->token_info;
...
static INLINE void alloc_altref_frame_buffer(AV2_COMP *cpi) {
  AV2_COMMON *cm = &cpi->common;
...
static INLINE void alloc_util_frame_buffers(AV2_COMP *cpi) {
  AV2_COMMON *const cm = &cpi->common;
  const SequenceHeader *const seq_params = &cm->seq_params;
...
static INLINE YV12_BUFFER_CONFIG *realloc_and_scale_source(AV2_COMP *cpi,
                                                           int scaled_width,
                                                           int scaled_height) {
  AV2_COMMON *cm = &cpi->common;
