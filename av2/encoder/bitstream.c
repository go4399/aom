...
static INLINE void write_inter_mode(
...
static INLINE void write_is_inter(const AV2_COMMON *cm,
...
static INLINE void av2_write_coeffs_txb_facade(
    aom_writer *w, AV2_COMMON *cm, MACROBLOCK *const x, MACROBLOCKD *xd,
...
static INLINE void write_single_ref(
...
static INLINE void write_ref_frames(const AV2_COMMON *cm,
...
static INLINE void write_dpcm_index(FRAME_CONTEXT *ec_ctx,
...
static INLINE void write_dpcm_uv_vert_horz_mode(
...
static INLINE void write_inter_segment_id(
    AV2_COMP *cpi, aom_writer *w, const struct segmentation *const seg,
...
static INLINE void write_intra_luma_mode(MACROBLOCKD *const xd,
                                             aom_writer *w) {
  FRAME_CONTEXT *ec_ctx = xd->tile_ctx;
  MB_MODE_INFO *const mbmi = xd->mi[0];
...
static INLINE void write_intra_prediction_modes(AV2_COMP *cpi,
                                                    int is_keyframe,
                                                    aom_writer *w) {
...
static INLINE void write_modes(AV2_COMP *const cpi,
                                   const TileInfo *const tile,
...
static INLINE void encode_restoration_mode(
    AV2_COMMON *cm, struct aom_write_bit_buffer *wb) {
...
static INLINE void write_wienerns_filter(
...
static INLINE void write_show_existing_frame(
    AV2_COMP *cpi, struct aom_write_bit_buffer *wb) {
  AV2_COMMON *const cm = &cpi->common;
  const SequenceHeader *const seq_params = &cm->seq_params;
