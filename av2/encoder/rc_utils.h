...
static INLINE void set_rc_buffer_sizes(RATE_CONTROL *rc,
...
static INLINE void config_target_level(AV2_COMP *const cpi,
 ...
 */
static INLINE int recode_loop_test(AV2_COMP *cpi, int high_limit, int low_limit,
...
static INLINE double av2_get_gfu_boost_projection_factor(double min_factor,
                                                         double max_factor,
                                                         int frame_count) {
...
static INLINE double av2_get_kf_boost_projection_factor(int frame_count) {
  double factor = sqrt((double)frame_count);
...
static INLINE int get_regulated_q_overshoot(AV2_COMP *const cpi, int q_low,
...
static INLINE int get_regulated_q_undershoot(AV2_COMP *const cpi, int q_high,
