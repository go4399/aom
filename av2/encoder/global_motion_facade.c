...
static INLINE void compute_global_motion_for_ref_frame(
    AV2_COMP *cpi, struct aom_internal_error_info *error_info,
...
static INLINE void alloc_global_motion_data(MotionModel *motion_models,
                                            uint8_t **segment_map,
...
static INLINE void dealloc_global_motion_data(MotionModel *motion_models,
                                              uint8_t *segment_map) {
...
static INLINE void pick_base_gm_params(AV2_COMP *cpi) {
  AV2_COMMON *const cm = &cpi->common;
...
static INLINE void setup_global_motion_info_params(AV2_COMP *cpi) {
  GlobalMotionInfo *const gm_info = &cpi->gm_info;
...
static INLINE void global_motion_estimation(AV2_COMP *cpi) {
  GlobalMotionInfo *const gm_info = &cpi->gm_info;
...
static INLINE void update_gm_stats(AV2_COMP *cpi) {
  const GF_GROUP *gf_group = &cpi->gf_group;
