...
static void av2_encode_vq_amvd(AV2_COMP *cpi, MV mv, aom_writer *w,
...
void av2_encode_mv(AV2_COMP *cpi, MV mv, aom_writer *w, nmv_context *mvctx,
...
void av2_encode_dv(aom_writer *w, const MV *mv, const MV *ref,
