...
static INLINE void wb_write_primitive_subexpfin(struct aom_write_bit_buffer *wb,
...
static INLINE int wb_count_primitive_subexpfin(uint16_t n, uint16_t k,
                                               uint16_t v) {
  int bits = 0;
  int i = 0;
  int mk = 0;
...
// options and speed.
static INLINE void enforce_max_ref_frames(AV2_COMP *cpi, int *ref_frame_flags) {
