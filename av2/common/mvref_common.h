...
static INLINE int get_block_position(const AV2_COMMON *cm, int *mi_r,
...
static INLINE int check_block_position(const AV2_COMMON *cm, int row,
...
static INLINE void get_mv_projection_clamp(MV *output, MV ref, int num,
...
static INLINE void tip_get_mv_projection(MV *output, MV ref,
                                             int scale_factor) {
