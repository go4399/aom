...
static INLINE ConvolveParams
av2_get_conv_params_no_round(int cmp_index, int plane, CONV_BUF_TYPE *dst,
...
static INLINE ConvolveParams av2_get_conv_params(int do_average, int plane,
                                                 int bd) {
  return av2_get_conv_params_no_round(do_average, plane, NULL, 0, 0, bd);
}

static INLINE WienerConvolveParams av2_get_conv_params_wiener(int bd) {
...
#define get_conv_params_no_round av2_get_conv_params_no_round
#define get_conv_params av2_get_conv_params
#define get_conv_params_wiener av2_get_conv_params_wiener
