...
static INLINE void check_tip_edge(const MB_MODE_INFO *const mbmi,
...
static INLINE void check_opfl_edge(const AV2_COMMON *const cm,
...
static INLINE void check_rfmv_edge(const AV2_COMMON *const cm,
                                       const MB_MODE_INFO *const mbmi,
...
static INLINE void check_sub_pu_edge(
...
static INLINE void set_tip_filter_length(
...
INLINE void loop_filter_tip_plane(AV2_COMMON *cm, const int plane,
...
static INLINE void setup_tip_dst_plane(struct buf_2d *dst, uint16_t *src,
...
// setup dst buffer
INLINE void setup_tip_dst_planes(AV2_COMMON *const cm, MACROBLOCKD *xd,
  ...
  setup_tip_dst_plane(&pd->dst, (uint16_t *)src->buffers[plane], src->widths[is_uv],
