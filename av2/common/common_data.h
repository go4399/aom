...
static const BLOCK_SIZE subsize_lookup[ALL_PARTITION_TYPES][BLOCK_SIZES_ALL] = {
  {
      // PARTITION_NONE
      BLOCK_4X4,                                    // 4
...
static INLINE PARTITION_TYPE sdp_chroma_part_from_luma(BLOCK_SIZE bsize,
                                                       PARTITION_TYPE luma_part,
                                                       int ssx, int ssy) {
...
// size function).
#ifndef ss_size_lookup_defined
#define ss_size_lookup_defined
...
static INLINE bool is_bsize_geq(BLOCK_SIZE bsize1, BLOCK_SIZE bsize2) {
...
static INLINE bool is_bsize_gt(BLOCK_SIZE bsize1, BLOCK_SIZE bsize2) {
  if (bsize1 == BLOCK_INVALID || bsize2 == BLOCK_INVALID) {
    return false;
  }
  return block_size_wide[bsize1] > block_size_wide[bsize2] &&
