...
static INLINE void sub_mul_add(const __m256i *id_next, const __m256i *id_prev,
                               const __m256i *id_next2, const __m256i *id_prev2,
                               const __m256i *coeff_0, const __m256i *coeff_1,
                               __m256i *temp_reg) {
...
static INLINE __m256i clamp_epi16(__m256i val, const int min_val,
                                  const int max_val) {
