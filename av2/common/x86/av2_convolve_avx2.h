...
static INLINE void dist_wtd_convolve_horiz_w4(
  ...
  __m256i s[2];
  DECLARE_ALIGNED(32, static const uint8_t, shuffle_mask0_loc[32]) = {
  ...
  for (int i = 0; i < im_h; i += 2) {
    ...
    const __m256i r0 = _mm256_permute2x128_si256(row0, row1, 0x20);
    s[0] = _mm256_shuffle_epi8(r0, _mm256_load_si256((__m256i *)shuffle_mask0_loc));
    s[1] = _mm256_shuffle_epi8(r0, _mm256_load_si256((__m256i *)shuffle_mask1_loc));
    const __m256i res_0 = _mm256_madd_epi16(s[0], coeffs[0]);
    const __m256i res_1 = _mm256_madd_epi16(s[1], coeffs[1]);
...
static INLINE void av2_highbd_convolve_2d_sr_bilinear_avx2(
  ...
  if (remain_wd == 4) {
    ...
    read = _mm256_shuffle_epi8(read, _mm256_loadu_si256((__m256i *)shuffle_mask1_loc_wd4));
    ...
    for (int i = 2; i < im_h; i += 2) {
      ...
      read1 = _mm256_shuffle_epi8(read1, _mm256_loadu_si256((__m256i *)shuffle_mask1_loc_wd4));
