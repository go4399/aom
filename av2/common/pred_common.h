...
static INLINE aom_cdf_prob *av2_get_pred_cdf_seg_id(
...
static INLINE aom_cdf_prob *av2_get_reference_mode_cdf(const AV2_COMMON *cm,
                                                       const MACROBLOCKD *xd) {
...
static INLINE aom_cdf_prob *av2_get_pred_cdf_single_ref(const MACROBLOCKD *xd,
...
static INLINE aom_cdf_prob *av2_get_pred_cdf_compound_ref(
