...
static INLINE int get_tip_block_width_with_same_mv(const AV2_COMMON *cm,
                                                   const TPL_MV_REF *tpl_mvs,
                                                   int unit_blk_size,
                                                   int blk_col, int blk_col_end,
...
static INLINE int is_tip_mv_refinement_disabled_for_unit_size_16x16(
...
static INLINE int tip_derive_scale_factor(int num, int den_signed) {
