...
static const struct arg_enum_list chroma_sample_position_enum[] = {
  { "unspecified", AOM_CSP_UNKNOWN }, { "left", AOM_CSP_VERTICAL },
  { "center", AOM_CSP_COLOCATED },    { "topleft", AOM_CSP_TOPLEFT },
  { "top", AOM_CSP_UNKNOWN },         { "bottomleft", AOM_CSP_BOTTOMLEFT },
  { "bottom", AOM_CSP_BOTTOM },       { NULL, 0 }
};
