...
#if CONFIG_AV2
  img->planes[AOM_PLANE_Y] = (uint8_t *)yv12->buffers_u16[AOM_PLANE_Y];
  img->planes[AOM_PLANE_U] = (uint8_t *)yv12->buffers_u16[AOM_PLANE_U];
  img->planes[AOM_PLANE_V] = (uint8_t *)yv12->buffers_u16[AOM_PLANE_V];
#else
...
#if CONFIG_AV2
  yv12->buffers_u16[AOM_PLANE_Y] = (uint16_t *)img->planes[AOM_PLANE_Y];
  yv12->buffers_u16[AOM_PLANE_U] = (uint16_t *)img->planes[AOM_PLANE_U];
  yv12->buffers_u16[AOM_PLANE_V] = (uint16_t *)img->planes[AOM_PLANE_V];
#else
  yv12->y_buffer = (uint8_t *)img->planes[AOM_PLANE_Y];
  yv12->u_buffer = (uint8_t *)img->planes[AOM_PLANE_U];
  yv12->v_buffer = (uint8_t *)img->planes[AOM_PLANE_V];
#endif
